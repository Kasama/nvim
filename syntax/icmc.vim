...
syntax region icmcChar start=/'/ skip=/\\'/ end=/'/
...
" MIPS registers
syntax keyword mipsRegister t0
syntax keyword mipsRegister t1
syntax keyword mipsRegister t2
syntax keyword mipsRegister t3
syntax keyword mipsRegister t4
syntax keyword mipsRegister t5
syntax keyword mipsRegister t6
syntax keyword mipsRegister t7
syntax keyword mipsRegister t8
syntax keyword mipsRegister t9
syntax keyword mipsRegister v0
syntax keyword mipsRegister v1
syntax keyword mipsRegister a0
syntax keyword mipsRegister a1
syntax keyword mipsRegister a2
syntax keyword mipsRegister a3
syntax keyword mipsRegister s0
syntax keyword mipsRegister s1
syntax keyword mipsRegister s2
syntax keyword mipsRegister s3
syntax keyword mipsRegister s4
syntax keyword mipsRegister s5
syntax keyword mipsRegister s6
syntax keyword mipsRegister s7
syntax keyword mipsRegister sp
syntax keyword mipsRegister ra
syntax keyword mipsRegister zero
syntax keyword mipsRegister at
syntax keyword mipsRegister k0
syntax keyword mipsRegister k1
syntax keyword mipsRegister gp
syntax keyword mipsRegister fp
syntax keyword mipsRegister hi
syntax keyword mipsRegister lo
...
syntax match mipsDirective "\.end_macro"
...
" Jump Instructions
syntax keyword mipsInstruction j
