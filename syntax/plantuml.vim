...
syntax keyword plantumlKeyword actor partition title activate as deactivate note left right top bottom of alt end
...
syntax match plantumlDirectedOrVerticalArrowLR /[-\.]\%(l\?e\?f\?t\?\|r\?i\?g\?h\?t\?\|u\?p\?\|\d\?o\?w\?n\?\)\?[-\.]\%(|>\|>>\|>\|\*\|o\>\|\\\\\|\\\|\/\/\|\/\|\.\|-\)\%(\[[^\]]*\]\)\?/ contains=plantumlLabel
syntax match plantumlDirectedOrVerticalArrowRL /\%(<|\|<<\|<\|\*\|\<o\|\\\\\|\\\|\/\/\|\/\)[-\.]\%(l\?e\?f\?t\?\|r\?i\?g\?h\?t\?\|u\?p\?\|\d\?o\?w\?n\?\)\?[-\.]\%(\[[^\]]*\]\)\?/ contains=plantumlLabel
...
" Skinparam keywords
syntax keyword plantumlSkinparamKeyword monochrome
