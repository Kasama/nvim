...
syn match hsImport		"\<import\>[^(]*(\?"he=s+6 contains=hsImportMod,hsLineComment,hsBlockComment,hsImportList,@NoSpell
syn match hsImportList		contained "(.*\n\?.*)"
...
syn region  hsPragma	       start="{-#" end="#-}" contains=hsPragmaLanguage
syn match   hsPragmaLanguage   contained "LANGUAGE \w*" contains=hsLanguageFeature
syn match   hsLanguageFeature  contained " \w*"
...
hi def link hsPragmaLanguage		  Label
hi def link hsLanguageFeature		  Structure
